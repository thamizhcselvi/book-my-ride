...
public class CarControllerTest {
    ...
    public void setup() {
        ...
        Car updatedCar = getCar("black",2L,Condition.NEW);
        updatedCar.setId(2L);
    ...
    public void updateCar() throws Exception{
        Car car = getCar("black",2L,Condition.NEW);
        mvc.perform(
                put(new URI("/cars/2"))
                        .content(json.write(car).getJson())
                        .contentType(MediaType.APPLICATION_JSON_UTF8))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.details.externalColor").value("black"));
    }
    ...
    public void deleteCar() throws Exception {
        Car car = getCar("white",1L,Condition.USED);
       // int id = Math.toIntExact(car.getId());
